package vitae.org.vitaewallet.service;
...
import vitae.org.vitaewallet.rate.CoinMarketCapApiClient;
import vitae.org.vitaewallet.rate.CoinTypes;
...
import static vitae.org.vitaewallet.service.IntentsConstants.ACTION_ADDRESS_BALANCE_CHANGE;
import static vitae.org.vitaewallet.service.IntentsConstants.ACTION_BROADCAST_TRANSACTION;
import static vitae.org.vitaewallet.service.IntentsConstants.ACTION_CANCEL_COINS_RECEIVED;
...
import static vitae.org.vitaewallet.service.IntentsConstants.ACTION_SCHEDULE_SERVICE;
...
import static vitae.org.vitaewallet.service.IntentsConstants.NOT_BLOCKCHAIN_ALERT;
import static vitae.org.vitaewallet.service.IntentsConstants.NOT_COINS_RECEIVED;

/**
 * Created by kaali on 6/12/17.
 */

public class VitaeWalletService extends Service{

    private Logger log = LoggerFactory.getLogger(VitaeWalletService.class);

    private VitaeApplication vitaeApplication;
    private VitaeModuleImp module;
    ...
    public class VitaeBinder extends Binder {
        public VitaeWalletService getService() {
            return VitaeWalletService.this;
        }
    }
        ...
        public void onBlocksDownloaded(final Peer peer, final Block block, final FilteredBlock filteredBlock, final int blocksLeft) {
            ...
            /*if (VitaeContext.IS_TEST)
                ...
                if (now - lastMessageTime > TimeUnit.SECONDS.toMillis(6)) {
                    ...
                    vitaeApplication.getAppConf().setLastBestChainBlockTime(block.getTime().getTime());
    ...
    private class RunnableBlockChecker implements Runnable{
        ...
        @Override
        public void run() {
            org.sendj.core.Context.propagate(VitaeContext.CONTEXT);
        ...
        public void onCoinsReceived(Wallet wallet, Transaction transaction, Coin coin, Coin coin1) {
            ...
            try {
                ...
                if (amount.isGreaterThan(Coin.ZERO)) {
                    ...
                    Intent resultIntent = new Intent(getApplicationContext(), VitaeWalletService.this.getClass());
                    resultIntent.setAction(ACTION_CANCEL_COINS_RECEIVED);
                    deleteIntent = PendingIntent.getService(VitaeWalletService.this, 0, resultIntent, PendingIntent.FLAG_CANCEL_CURRENT);
                    mBuilder = new NotificationCompat.Builder(getApplicationContext())
                            .setContentTitle("Vitae received!")
                            ...
                            .setColor(
                                    (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) ?
                                            ...
                                            :
                                            ContextCompat.getColor(VitaeWalletService.this, R.color.bgPurple))
    ...
    public void onCreate() {
        ...
        super.onCreate();
        try {
            log.info("Vitae service started");
            // Android stuff
            ...
            module = (VitaeModuleImp) vitaeApplication.getModule();
            blockchainManager = module.getBlockchainManager();
            // connect to bwktrum node
            /*bwktrumPeergroup = new BwktrumPeergroup(vitaeApplication.getNetworkConf());
            ...
            String filename = VitaeContext.Files.BLOCKCHAIN_FILENAME;
            boolean fileExists = new File(file,filename).exists();
            blockchainStore = new SnappyBlockchainStore(VitaeContext.CONTEXT,file,filename);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        log.info("Vitae service onStartCommand");
        try {
            if (intent != null) {
                try {
    ...
    private void requestRateCoin(){
        final AppConf appConf = vitaeApplication.getAppConf();
        VitaeRate vitaeRate = module.getRate(appConf.getSelectedRateCoin());
        if (vitaeRate==null || vitaeRate.getTimestamp()+VitaeContext.RATE_UPDATE_TIME<System.currentTimeMillis()){
            new Thread(new Runnable() {
                @Override
                public void run() {
                    try {
                        CoinMarketCapApiClient c = new CoinMarketCapApiClient();
                        BigDecimal usdValue = c.getVitaePrice();
                        VitaeRate vitaeRate = new VitaeRate(CoinTypes.USD.name(),usdValue,System.currentTimeMillis(),"coinmarketcap");
                        module.saveRate(vitaeRate);
                    } catch (RequestVitaeRateException e) {
                        e.printStackTrace();
                    } catch (Exception e){
                        e.printStackTrace();
                    }
