...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final VitaeApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (VitaeContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + VitaeContext.NETWORK_PARAMETERS.getId() + "\n");
