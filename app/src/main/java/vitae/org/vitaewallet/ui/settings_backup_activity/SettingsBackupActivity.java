package vitae.org.vitaewallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = vitaeModule.backupWallet(backupFile, firstPassword);

            if (result){
                vitaeApplication.getAppConf().setHasBackup(true);
