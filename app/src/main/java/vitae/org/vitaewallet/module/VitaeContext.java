...
public class VitaeContext {
    ...
    /** Vitae wallet released time */
    public static final long VITAE_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME = 1500940800;

    // report mail
    public static final String REPORT_EMAIL = "kalilinuxoo7g@gmail.com";
    ...
    public static final class Files{
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "vitae-wallet-backup" +"_"+ FILENAME_NETWORK_SUFFIX;
