package vitae.org.vitaewallet.ui.words_restore_activity;
...
import static vitae.org.vitaewallet.module.VitaeContext.VITAE_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
                        ...
                        new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                try {
                                    ...
                                    vitaeModule.checkMnemonic(mnemonic);

                                    boolean isBip32 = check_bip32.isChecked();

                                    vitaeModule.restoreWallet(mnemonic, VITAE_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, VitaeContext.ENABLE_BIP44_APP_VERSION));
